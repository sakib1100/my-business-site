    ...
    return (
        <div>
           ...
           <div className='row text-center'>
            ...
            <div className=' grid grid-cols-2 text-center max-sm:justify-center max-sm:grid-cols-1'>
                <img className='lg:w-6/6 max-sm:w-11/12 md-w-10/12 max-sm:ml-4'  src={image}></img>
                <img className='lg:w-6/6 max-sm:w-11/12 md-w-10/12 max-sm:ml-4' src={image2}></img>
            </div>
           </div>
            </div>
        </div>
